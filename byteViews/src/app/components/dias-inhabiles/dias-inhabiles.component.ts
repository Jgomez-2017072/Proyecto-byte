...
export class EditarDiaInhabil {
  constructor(
    public dialogRef: MatDialogRef<EditarDiaInhabil>, private snackBar: MatSnackBar) {}
...
export class EliminarDiaInhabil {
  ...
  constructor(
    public dialogRef: MatDialogRef<EliminarDiaInhabil>, private snackBar: MatSnackBar) {}
...
export class AgregarDiaInhabil {
  ...
  constructor(
    public dialogRef: MatDialogRef<AgregarDiaInhabil>, private snackBar: MatSnackBar) {}
