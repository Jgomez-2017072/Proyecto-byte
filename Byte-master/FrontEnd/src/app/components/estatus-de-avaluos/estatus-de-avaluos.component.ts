...
@Component({
  selector: 'app-estatus-de-avaluos',
  templateUrl: './estatus-de-avaluos.component.html',
  styleUrls: ['./estatus-de-avaluos.component.scss']
})
export class EstatusDeAvaluosComponent implements OnInit {
