...
@Component({
  selector: 'app-origen-de-los-fondos',
  templateUrl: './origen-de-los-fondos.component.html',
  styleUrls: ['./origen-de-los-fondos.component.scss']
})
export class OrigenDeLosFondosComponent implements OnInit {
